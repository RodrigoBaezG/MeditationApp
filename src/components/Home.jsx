    ...
    return (
        ...
        <div className="home-container">
            ...
            <div className="hero-section">
                ...
                <img 
                    src="public/Home.jpg" // <-- Reemplaza esto con la ruta real de tu imagen
            ...
            <div className="info-section">
                ...
                <p>We want peace. We recognize that we are not in peace and that we do not know how to reach it. To meditate is to strengthen our willingness to surrender to the truth.</p>
